        ...
        <section className="w-full flex flex-col gap-6">
            ...
            <table className="w-full">
                ...
                <tbody className="inter flex flex-col gap-2">
                    <TableRow position={1} teamName={"Tech Titans"} points={70} onClick={openModal}/>
                    <TableRow position={2} teamName={"Tech Titans"} points={69} />
                    <TableRow position={3} teamName={"Tech Titans"} points={54} />
                    <TableRow position={4} teamName={"Tech Titans"} points={40} />
                </tbody>
            </table>
            ...
            {modalOpen && (
                    <Backdrop onClose={closeModal}>
                        ...
                        onClick={(e) => e.stopPropagation()}
                            className="px-6 py-8 flex flex-col gap-2 mx-5 rounded-2xl text-black
                                bg-greyscale_background_light text-center
                                w-[343px] md:w-[408px] md:text-start"
                        >
                            <p>Edit this teams’ score</p>
                            <input className="outline-none bg-greyscale_surface_subtle py-3 px-4" placeholder="Enter team's score" />
                            <div className="flex flex-col md:flex-row gap-3 w-full">
                                ...
                                <ButtonBlue classname={"w-full sm:w-full lg:w-full"}>Save</ButtonBlue>
                            </div>
                        </motion.div>
                    </Backdrop>
            )}
