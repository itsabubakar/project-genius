...
export default function TableRow({ position, teamName, points, onClick }) {
    ...
    return (
        //bg-[#EEF2FF]
        <tr onClick={onClick} className="flex items-center border border-greyscale_border rounded-2xl py-4 px-2">
            {/* Rank */}
            ...
            <th className="ml-auto font-medium mr-6"><Image src={element} alt="" /> </th>
        </tr>
    )
}