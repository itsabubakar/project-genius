...
export default async function Home({}) {
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-12 sm:px-6 sm:py-16 lg:py-20">
      <header>
        <h1 className="leading-tighter font-heading mb-8 text-4xl font-bold tracking-tighter md:mb-16 md:text-5xl">
          Events
        </h1>
      </header>
      <div className="grid sm:grid-cols-2 gap-6  p-4 md:p-0 lg:grid-cols-3">
